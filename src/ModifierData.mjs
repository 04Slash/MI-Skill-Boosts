...
export function getCommonModifiers(skillID) {
	...
	if (!combat) modifiers.push('additionalRandomSkillItemChancePerInterval', 'randomProductChance', 'flatBaseRandomProductQuantity', 'additionalRandomSkillItemChance', 'flatAdditionalSkillItem', 'additionalItemBasedOnPrimaryQuantityChance', 'skillItemDoublingChance', 'doubleItemsSkill');
